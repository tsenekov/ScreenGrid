...
procedure TfrmGridSettings.btnCloseClick(Sender: TObject);
begin
  SaveSettings;
  Hide;
end;

procedure TfrmGridSettings.SaveSettings;
var
  Reg: TRegistry;
begin
...
procedure TfrmGridSettings.btnExitClick(Sender: TObject);
begin
  Application.Terminate;
end;

procedure TfrmGridSettings.FormCreate(Sender: TObject);
begin
  LoadSettings;
end;

procedure TfrmGridSettings.LoadSettings;
var
  Reg: TRegistry;
begin
  Reg := TRegistry.Create;
